...
public slots:	
    ...
    void FUZHI(void);
    void comboBoxChange(int);
    void ClearTable(void);
    void  BtnStartClick     ();
    void  BtnSaveClick      ();
    void pushButton_2Click();
    void  BtnStopClick      ();
    //void  BtnPlotClick      ();
    void  BtnOptClick       ();
    void  BtnExitClick      ();
...
private:
   ...
   void  UpdateLog    (int stat, gtime_t time, double *rr, float *qr,
    ...
    void ShowObs(void);
    void SetObs(void);
    void  savenav(QTableWidget* tableWidget);
    void SaveObs(QTableWidget* tableWidget);
    //void SaveObs(QTableWidget* tableWidget, QString dirName, QString fileName);
    //void  SaveObs(void);
    void SetNav(void);
